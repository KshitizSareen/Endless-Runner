...
void ARunnerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Restart", IE_Pressed, this, &ARunnerCharacter::OnRestart).bExecuteWhenPaused=true;
}
...
void ARunnerCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}
void ARunnerCharacter::OnRestart()
{
